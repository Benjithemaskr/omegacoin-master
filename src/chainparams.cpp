...
{
  const char* pszTimestamp = "I believe life is an intelligent thing: that things aren't random.";
...
public:
  CMainParams() {
    ...
    genesis = CreateGenesisBlock(1523928159, 966865, 0x1e0ffff0, 1, 50 * COIN);

    consensus.hashGenesisBlock = genesis.GetHash();
    printf("Hash: %s", consensus.hashGenesisBlock.ToString().c_str());
    
    assert(consensus.hashGenesisBlock == uint256S("0000079c5a095b3cab8298a3dc8a418a8613e0f307152b46c61ef5b1f7ae203e"));
    assert(genesis.hashMerkleRoot == uint256S("0x544720aefb0d77bcd19f04619ffd6fd9c0656d4c5a500eebd860e1cd4478e497"));
    ...
    checkpointData = (CCheckpointData) {
      ...
      ( 0, uint256S("0x0000041a9498884aa2506b9dc832af53de1cbee3dca196a8d7b4319ee3a0f27c")),
      1517519966, // * UNIX timestamp of last checkpoint block
